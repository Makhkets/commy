...
Начиная с `v0.1.0-alpha.9` релизы подписаны ключом проекта, и обновления ставятся поверх. Проверить скачанный файл: `apksigner verify --print-certs commy-<версия>.apk` должен показать SHA-256 сертификата `49f1018be3c298a94cdba9a4a92737300680562b7be095ddd4fe3e2e42d3882e`.

| Платформа             | Состояние                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------------------- |
| **Android**             | Этап M1 закрыт: девять протоколов возят трафик через живые серверы — на эмуляторах и на настоящем телефоне |
...
Что уже есть: шесть Dart-пакетов, покрытых 1544 тестами, ядро sing-box, собранное под три
