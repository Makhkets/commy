...
Что есть: шесть пакетов, 724 теста, чистый анализ, ядро sing-box под три ABI,
Android-туннель (`VpnService`, `PlatformInterface` 15/15, `BootReceiver`, плитка,
Doze), все экраны приложения, deep links, APK с ядром внутри.
