...
**Последний прогресс:** 2026-09-10 — закрыты **#6–#9** (меню подписки, меню
узла, автообновление, «Замерить все» пачками) и весь блок маршрутизации
**#11–#13** (экран DNS, выбор приложений с новым методом канала
`installedApps`, наборы правил E-2 — загрузка **и** передача пути сборщику).
Приложение: 106 тестов вместо 44, `commy_ui` не тронут, golden'ы не менялись.
**Не сделано и важно:** чек-лист утечек (R6) после #13 — правила
`geosite:`/`geoip:` теперь реально применяются, это изменение маршрутизации и
требует телефона. Kotlin-половина #12 не компилировалась здесь. Следующему:
хвост очереди — **#14**, **#17**, **#15**, **#18**, **#16**, **#19**; детали —
в docs/17-agent-handoff.md, «Сессия 5».
