...
Самое главное и самое незаконченное. Агент довёл его до ~32 файлов и оборвался;
проверь, что на диске, **прежде** чем что-либо переписывать — за эту сессию
трижды оказывалось, что работа сделана, а потерян только финальный отчёт.

Чего не хватает: экран маршрутизации, диагностика (логи, соединения, конфиг,
статистика), «Внешний вид», «О программе», виджет-тесты главного экрана во всех
шести состояниях туннеля через `FakeCoreClient`.
