...
Восьмой, `openVpnSettings`, к туннелю не относится и описан отдельно в конце
раздела — он открывает системный экран и ничего про туннель не знает.
...
- [ ] семь туннельных методов плюс `openVpnSettings`, каждый **всегда**
