...
Ещё три — `openVpnSettings`, `setStartOnBoot` и `installedApps` — к туннелю
не относятся и описаны отдельно в конце раздела: они говорят с системой и
ничего про туннель не знают.
